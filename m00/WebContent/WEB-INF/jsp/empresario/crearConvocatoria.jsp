...
<title>ATRABAJAR | Crear Convocatoria</title>
	...
	<div class="col-md-12">
		<div class="portlet box blue-hoki" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> Crear Convocatoria - <span class="step-title">1 de 4 </span>
				</div>
				<div class="actions">
						...
						<div class="form-body">
							<ul class="nav nav-pills nav-justified steps">
								<li>
									...
									<span class="desc"><i class="fa fa-check"></i> Trabajo </span>
									</a>
								</li>
								<li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="tab1">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Cargo <span class="required">* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										<div class="col-md-6" style="padding-left: 0px;"><input class="form-control" type="text" placeholder="Desde S/."></div>
										<div class="col-md-6" style="padding-right: 0px;"><input class="form-control" type="text" placeholder="Hasta S/."></div>
										</div>
									</div>
